      ...
      <table border="0" cellpadding="20" cellspacing="0" width="600" id="emailContainer">
        <tr>
          <td align="left" valign="top">
            ...
            <p style="padding-top:10px;">Dear <?php echo e($data['name']); ?>,</p>
            ...
            <p style="margin-top:0; margin-bottom:0;"><?php echo e(Auth::user()->name); ?></p>
            <p style="margin-top:0; margin-bottom:0;"><a href="mailto:jmaloy2@polarisdirect.net?subject=RE: Keep an eye on your mailbox"><?php echo e(Auth::user()->email); ?></a></p>
...
</table><?php /**PATH C:\xampp\htdocs\Udash\resources\views\mailUsers.blade.php ENDPATH**/ ?>