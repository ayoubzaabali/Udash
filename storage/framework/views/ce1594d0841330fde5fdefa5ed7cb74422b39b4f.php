...
<body class="form-membership" style='background: url("<?php echo asset('"<?php echo asset('assets/css/app.min.css')  ?>"')  ?>")'>
...
<?php /**PATH C:\xampp\htdocs\Udash\resources\views\lock-screen.blade.php ENDPATH**/ ?>