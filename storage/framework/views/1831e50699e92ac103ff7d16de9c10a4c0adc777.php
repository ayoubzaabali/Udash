...
<div class="up">Collaborate in real-time, Anytime, Anywhere
    . <a href="<?php echo e(Route('login')); ?>">Check Now!</a></div>
<div id="firstSection">
    <div class="container">
        <nav>
            <div id="logo"  onclick='location.reload(true); return false;'>Udash.</div>
            <div id="navbar">
                <ul>
                    <li><a href="#firstSection"  onclick='location.reload(true); return false;'>Home</a></li>
                    <li> <a href="#section4">Testimonials</a></li>
                    <li> <a href="#contact">Contact Us</a></li>
                    <li><a href="#section2">About us</a></li>
                </ul>
            </div>
            <div id="button" onclick="window.location.href='<?php echo e(Route('login')); ?>'" ><button>Sign-in</button></div>
        </nav>
    </div>
    ...
    <div class="first-content">
        <div class="container content">
            ...
            <img style="max-height:200px;margin-top:auto;animation: shake 1.5s infinite;display:none"
                src="<?php echo e(asset('assets/media/image/pngegg (5).png')); ?>" alt="">
            <div class="btns">
                <button onclick="window.location.href='<?php echo e(Route('login')); ?>'" >Try for Free</button>
                <button onclick="window.location.href='<?php echo e(Route('login')); ?>'" >See Plans & Offers</button>
            </div>
        </div>
        <div class="guys">

            <img class="asyncImage display" src="<?php echo e(asset('assets/media/image/men1-min.webp')); ?>"
                data-src="<?php echo e(asset('assets/media/image/men1.webp')); ?>" loading="lazy" decoding="async" height="630"
                width="280" alt="Beautiful landscape sunrise">

            <img class="asyncImage" src="<?php echo e(asset('assets/media/image/men.webp')); ?>"
                data-src="<?php echo e(asset('assets/media/image/men.webp')); ?>" loading="lazy" decoding="async" height="650"
                width="480" alt="Beautiful landscape sunrise">

            <img class="asyncImage" src="<?php echo e(asset('assets/media/image/men3.webp')); ?>"
                data-src="<?php echo e(asset('assets/media/image/men3.webp')); ?>" loading="lazy" decoding="async" height="630"
    ...
    <div id="img-list">
        <h4>Trusted By :</h4>
        <img src="<?php echo e(asset('assets/media/image/company/img1.png')); ?>" alt="image not found">
        <img src="<?php echo e(asset('assets/media/image/company/img2.png')); ?>" alt="image not found">
        <img src="<?php echo e(asset('assets/media/image/company/img3.png')); ?>" alt="image not found">
        <img src="<?php echo e(asset('assets/media/image/company/img4.png')); ?>" alt="image not found">
        <img src="<?php echo e(asset('assets/media/image/company/img5.png')); ?>" alt="image not found">
    </div>
...
<div id="section2">
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="reveal"><img id="img" src="<?php echo e(asset('assets/media/image/cloud.webp')); ?>" alt=""></div>
        </div>
    </div>
</div>
...
<div id="section4">
    ...
    <div class="testimonials-section">
        <h1 style="position:absolute;top:0;" class="h1 reveal">Customer <span style="color:#fff">Testimonials</span>
        </h1>
        ...
        <div class="slider__inner">
            <div class="slider__contents reveal">
                <quote>&rdquo;</quote>
                <img src="<?php echo e(asset('assets/media/image/user/man_avatar1.jpg')); ?>" style="width:100%">
            ...
            <div class="slider__contents reveal">
                <quote>&rdquo;</quote>
                <img src="<?php echo e(asset('assets/media/image/user/man_avatar2.jpg')); ?>" style="width:100%">
            ...
            <div class="slider__contents reveal">
                <quote>&rdquo;</quote>
                <img src="<?php echo e(asset('assets/media/image/user/man_avatar3.jpg')); ?>" style="width:100%">
            ...
            <div class="slider__contents reveal">
                <quote>&rdquo;</quote>
                <img src="<?php echo e(asset('assets/media/image/user/man_avatar4.jpg')); ?>" style="width:100%">
            ...
            <div class="slider__contents reveal">
                <quote>&rdquo;</quote>
                <img src="<?php echo e(asset('assets/media/image/user/man_avatar5.jpg')); ?>" style="width:100%">
    ...
    <svg class="svg2" viewBox="0 0 1440 320">
...
<div id="section3">
    <div class="container">
        <div class="content reveal">
            ...
            <div class="tree"><button>Get a Call Back</button></div>
        </div>
    </div>
</div>
...
<div id="cta">
    <div class="container">
        <button onclick="window.location.href='<?php echo e(Route('login')); ?>'" >Join Now</button>
    </div>
</div>
...
<?php echo $__env->make('layouts.homePage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Udash\resources\views/home.blade.php ENDPATH**/ ?>