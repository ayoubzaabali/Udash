  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content"  >
      ...
      <div class="modal-body" >
        <form id="messageForm" action="{{route('sendmail')}}" method="post" >
            @csrf
            <input type="hidden" name="members" id="catIDM" value="{{$data['members']}}">
                ...
                <div class="header-body-right">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a href="{{route('setd')}}" class="nav-link nav-link-notify" title="Settings" data-sidebar-target="#settings">
                            ...
                            <a href="#" class="nav-link profile-nav-link dropdown-toggle" title="User menu"
                               data-toggle="dropdown">
                                ...
                                <figure class="avatar avatar-sm">
                                        ...
                                        <img  src="{{url('/').'/storage/app/'.Auth::user()->photo}}"
                                ...
                                <div class="text-center py-4"
                                    ...
                                    <figure  class="avatar avatar-xl">
                                        ...
                                        <img id="myphoto"  src="<?php echo asset('assets/media/image/user/default.png')  ?>"
                                             class="rounded-circle" alt="image">
                                        @else
                                        <img id="myphoto" onclick="changePhoto(this)"   src="{{url('/').'/storage/app/'.Auth::user()->photo}}"
                                             class="rounded-circle" alt="image">
                                        @endif
