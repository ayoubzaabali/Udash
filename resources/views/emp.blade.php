                    ...
                    <table id="emp-list" class="table table-borderless table-hover">
                      ...
                      @foreach($data['emp'] as $emp)
                        ...
                        <tr>
                            <td>
                                <a href="#">
                                @if(empty($emp->photo) or is_null($emp->photo))
                                ...
                                <figure class="avatar avatar-sm">
                                        ...
                                        <img   src="{{url('/').'/storage/app/'.$emp->photo}}"
...
<form method="post" action="{{ route('emp.index') }}"
      class="dropzone"
