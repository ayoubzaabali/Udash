...
(function ($) {
  ...
  $(document).on('click', '[data-sidebar-target]', function (evt) {
    ...
    var elem=evt.target;
    var realTarget= $('.sidebar-group .sidebar' + target);
    realTarget=realTarget.children(0).children(1);
    console.log(realTarget);
    realTarget[3].lastElementChild.firstElementChild.innerText=elem.getAttribute("original");//='elem.getAttribute("original")'; 
   // realTarget.children(3).children(5).text(elem.getAttribute("size")+"KB");//='elem.getAttribute("original")';  
    realTarget[4].lastElementChild.innerText=elem.getAttribute("size")+"KB";
    realTarget[5].lastElementChild.innerText=elem.getAttribute("owner");
      realTarget[6].lastElementChild.innerText=elem.getAttribute("date");
      realTarget[7].firstElementChild.setAttribute("href",elem.getAttribute("fileid"));
    if (wind_.width() < 1200) {
      $.createOverlay();
